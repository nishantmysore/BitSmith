...
const authRequiredPaths = ['/home', '/public', '/mydevices', '/upload', '/schema'] // add your protected routes
const subscriptionRequiredPaths = ['/home', '/public', '/mydevices', '/upload', '/schema'] // add routes that need subscription
...
export async function middleware(request: NextRequest) {
  ...
  if (requiresSubscription) {
    try {
      const subscriptionRes = await fetch(`${request.nextUrl.origin}/api/check-subscription`, {
